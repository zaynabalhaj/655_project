...
# The three testing scripts were AI generated;
# Prompt : write a python script to run on mininet vm, the topology should consist of 18 hosts and 6 switches and generate normal tarffic
class MyTopo( Topo ):
...
def startNetwork():
    ...
    src = choice(hosts)
    dst = ip_generator()            
    print("generating normal TCP/UDP traffic between %s and h1" % (src))
    src.cmd("iperf -p 5050 -c 10.0.0.1 -t 3")
